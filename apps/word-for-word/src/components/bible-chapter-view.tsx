...
>(
  (
    ...
    const [searchResultHighlight, setSearchResultHighlight] =
      useState<BibleCursor | null>(null);
    ...
    useEffect(() => {
      const unmount = sessionLogger.mountBibleChapterView(
        cursorHandler,
        verseYCoordsRef,
        scrollYRef,
        scrollViewHeightRef
            ...
            onTextLayout={(e) => {
              ...
              for (const line of lines) {
                ...
                if (currentTextLength > currentVerseTextLength) {
                  ...
                  currentVerseTextLength +=
                    ` ${currentVerse.verse} `.length + currentVerse.text.length;
          ...
          >
            {verses.map((verse, i) => {
              ...
              const isSearchResultHighlight =
                searchResultHighlight?.verse === i + 1;
                  ...
                  >
                    ...
                    <TText
                      style={{
                        ...
                        ...(isSearchResultHighlight && {
                          backgroundColor: themeColors.highlighterBlue,
                        }),
                        ...(isSelected && {
