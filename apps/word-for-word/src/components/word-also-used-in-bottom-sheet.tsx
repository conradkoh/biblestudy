...
const WordAlsoUsedInBottomSheet: FC<WordAlsoUsedInBottomSheetProps> = ({
  cursorHandler,
  currentStrongsWord,
  onSelectVerse,
  isOpen,
  ...
  const alsoUsedInVerses =
    currentStrongsWord && cursorHandler.cursor.verse
      ? bible.findVersesByStrongsNumber(
  ...
  const renderItem = useCallback(
    ({
      ...
      item: ReturnType<typeof bible.findVersesByStrongsNumber>[number];
    }) => {
      return (
